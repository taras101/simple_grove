$(document).ready(function(){
    ...
    function setupMouseEvents(){
        ui.nodeGroup.on('mouseover', function(d, i)
        {
            ...
            {
                d3.select(this).style("display","none").append("svg:image")
